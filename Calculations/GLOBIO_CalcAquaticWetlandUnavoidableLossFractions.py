...
# ******************************************************************************
#-------------------------------------------------------------------------------
# Created: 22 jun 2022, MB, PBL
#           - Version 4.0.12
#           - Copy of GLOBIO_CalcAquaticWetlandLossFraction.py
#           - Different indicator, unavoidable loss of wetland
#-------------------------------------------------------------------------------
...
#-------------------------------------------------------------------------------
#-------------------------------------------------------------------------------
class GLOBIO_CalcAquaticWetlandUnavoidableLossFractions(CalculationBase):
  """
  Creates a raster with the fractions of unavoidable loss and actual wetlands.
  """
  ...
  def run(self,*args):
    ...
    lossMask = (outLossFracRaster.r > 1)
    noLossMask = (outLossFracRaster.r <= 1)
    outLossFracRaster.r[lossMask] = outLossFracRaster.r[lossMask] - 1.0
    outLossFracRaster.r[noLossMask] = 0.00000001
...
if __name__ == "__main__":
  try:
    ...
    pCalc = GLOBIO_CalcAquaticWetlandUnavoidableLossFractions()

...
#-------------------------------------------------------------------------------
#-------------------------------------------------------------------------------
class GLOBIO_CalcNaturalLanduse(CalculationBase):
  """
  Creates a raster with natural landuse.
  """
...
if __name__ == "__main__":
  try:
    ...
    pCalc = GLOBIO_CalcNaturalLanduse()
    ext = GLOB.extent_World
    lu = os.path.join(inDir,"glc2000_aris.tif")
    lut = os.path.join(lookupDir,"NaturalLanduse.csv") 
    out = os.path.join(outDir,"NaturalLanduse.tif")

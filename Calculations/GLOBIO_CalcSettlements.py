...
#-------------------------------------------------------------------------------
#-------------------------------------------------------------------------------
class GLOBIO_CalcSettlements(CalculationBase):
  """
  Creates a raster with settlements (i.e. man-made landuse).
  """
...
if __name__ == "__main__":
  try:
    ...
    lut = os.path.join(lookupDir,"Settlements.csv") 
    out = os.path.join(outDir,"Settlements.tif")
